...
public class ManageInput : MonoBehaviour
{
	...
	void Update ()
	{
		...
		if (!Character_01SkillPress [1]) {
			Character_01SkillPress [1] = CrossPlatformInputManager.GetButtonDown ("Character1_dodge_m");
		}
		if (Character_01SkillPress [1]) {
			Character_01SkillPress [1] = !CrossPlatformInputManager.GetButtonUp ("Character1_dodge_m");
		}
		/////////////////////////////////
